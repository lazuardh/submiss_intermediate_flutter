...
class _$AuthStateLoadedImpl implements AuthStateLoaded {
  const _$AuthStateLoadedImpl();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$AuthStateLoadedImpl);
  }
...
abstract class AuthStateLoaded implements AuthState {
  const factory AuthStateLoaded() = _$AuthStateLoadedImpl;
}
...
class _$AuthStateErrorImpl implements AuthStateError {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$AuthStateErrorImpl);
  }
...
abstract class AuthStateError implements AuthState {
  const factory AuthStateError() = _$AuthStateErrorImpl;
}
